...
public class RedisConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        cacheConfigs.put("paymentById",              defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigs.put("paymentByAppointment",     defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigs.put("paymentsByPatient",        defaultConfig.entryTtl(Duration.ofMinutes(10)));
